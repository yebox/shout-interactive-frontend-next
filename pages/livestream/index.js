    ...
    <>
      <BaseLayout>
        ...
        <div
          ...
          className="w-full h-full px-[1.6rem] pt-[2.4rem] pb-[3.4rem] relative bg-slate-400 flex flex-col"
        >
          {/* Header Section */}
          ...
          {/* Chatbox Section */}
          <section className="h-[50vh] relative mt-auto flex flex-col items-center left-0">
            {/* Chats */}
